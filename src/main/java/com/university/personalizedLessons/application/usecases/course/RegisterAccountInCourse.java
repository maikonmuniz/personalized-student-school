...
public class RegisterAccountInCourse {
    ...
    public Output execute (Input input) {
        ...
        if (input.accountID == null || input.accountID.isEmpty()) throw this.exceptionAdapter.badRequest("There is no account!");
        if (input.courseID == null || input.courseID.isEmpty()) throw this.exceptionAdapter.badRequest("There is no course!");
